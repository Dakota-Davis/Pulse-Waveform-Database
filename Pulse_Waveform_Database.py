...
""" #Previous method of making sure pmt & scintillator was specified#
...
"""
"""  #Will not require these to be specified for --add purposes#
...
if args.add is not None:
    ...
    os.system("cp %s %s" %(args.add, path))                  #coppies --add file to path
...
if args.psd_cut is not None:        #temporary check to prevent running errors while writing new code 
    ...
    #path = args.add			#Accepts input file
